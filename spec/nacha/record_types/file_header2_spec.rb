...
RSpec.describe "Nacha::Record::FileHeader2", :nacha_record_type do
  ...
  it 'exists' do
    expect { Nacha::Record::FileHeader2 }.to_not raise_error()
  end

  it 'generates a valid unpack string' do
    expect(Nacha::Record::FileHeader2.unpack_str).to eq 'A1a2A10A10A6A4A1A3A2A1A23A23A8'
  end

  it 'generates a regexp matcher' do
    expect(Nacha::Record::FileHeader2.matcher).to be_a Regexp
  end

  it 'generates a valid matcher' do
    expect(Nacha::Record::FileHeader2.matcher).to eq /\A1.................................094101......................................................\z/
  end

  it 'recognizes input' do
    expect(Nacha::Record::FileHeader2.matcher).to match example_file_header_record
  end

  describe 'parses a record' do
    let(:fhr) { Nacha::Record::FileHeader2.parse(example_file_header_record) }
  ...
  describe 'generates json' do
    let(:fhr_json) { Nacha::Record::FileHeader2.parse(example_file_header_record).to_json }
