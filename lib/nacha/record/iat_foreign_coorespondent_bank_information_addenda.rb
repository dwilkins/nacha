...
module Nacha
  module Record
    class IatForeignCoorespondentBankInformationAddenda < Nacha::Record::Base
      ...
      nacha_field :foreign_coorespondent_bank_identification_number_qualifier, inclusion: 'M',
        contents: 'Alphameric', position: 39..40
      nacha_field :foreign_coorespondent_bank_identification_number, inclusion: 'M',
        contents: 'Alphameric', position: 41..74
      nacha_field :foreign_coorestpondent_bank_branch_country_code, inclusion: 'M', contents: 'Alphameric',
        position: 75..77
